                ...
                <?php 
                    ...
                    while ($ingredient = mysqli_fetch_assoc($ingredients)) {
                        ...
                        if (!empty($ingredientData)) {
                            ...
                            $ingredientQty = mysqli_fetch_array(mysqli_query($DBConnect, "SELECT ingredientName, quantity FROM ingredient WHERE ingredientID = " . $ingredient['ingredientID'] . ""));
                            if ($ingredientQty['quantity'] <= $threshold) echo "<li>" . $ingredientQty['ingredientName'] . " needs to be replenished </li>";
                            // else echo "<li>" . $ingredient['ingredientID'] . " = " . $ingredientQty['quantity'] . " / " . $threshold . "</li>";
                        }
                    }
                ?>
            </ul>
